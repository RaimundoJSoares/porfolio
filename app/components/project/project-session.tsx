...
const ProjectSection = () => {
  return (
    ...
    >
      <article className="relative mb-5 h-[200px] w-[350px] sm:w-auto sm:h-[350px] shadow-xl shadow-gray-400 round-xl p-4 group hover:bg-gray-950 rounded-lg">
        <figure>
          <Image
      ...
      <article className="relative flex items center justify-center mb-5 h-[200px] w-[350px] sm:w-auto sm:h-[350px] shadow-xl shadow-gray-400 round-xl p-4 group hover:bg-gray-950 rounded-lg">
        <figure>
          <Image
            src="/images/chat.png"
            alt="Visualize"
